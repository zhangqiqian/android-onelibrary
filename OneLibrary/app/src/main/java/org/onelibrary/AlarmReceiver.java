...
*/
    ...
    //private PendingIntent networkIntent;
     ...
     * @param context
     */
    public void setFetchAlarm(Context context) {
     ...
     * @param context
     */
    public void setNetworkAlarm(Context context) {
        alarmMgr = (AlarmManager)context.getSystemService(Context.ALARM_SERVICE);
        Intent intent = new Intent(context, NetworkReceiver.class);
        //networkIntent = PendingIntent.getBroadcast(context, 0, intent, 0);
        ...
        // clock, and to repeat once a day.
        /*alarmMgr.setInexactRepeating(AlarmManager.RTC_WAKEUP,
                calendar.getTimeInMillis(), 60 * 1000, networkIntent);
*/
        // Enable {@code SampleBootReceiver} to automatically restart the alarm when the
        // device is rebooted.
        ComponentName receiver = new ComponentName(context, BootReceiver.class);
